          ...
          {step === 2 && (
            <div className="text-center p-6 space-y-6" id="gpay-modal-simulation">
              ...
              <div className="space-y-2 text-left bg-[#021816] p-5 rounded-2xl border border-white/5 text-white">
                ...
                <div className="flex justify-between items-center text-xs">
                  <span className="text-white/50 uppercase tracking-wide font-mono font-medium">Devotee Email:</span>
                  <span className="font-semibold text-white/90">{email}</span>
                </div>
                <div className="flex justify-between items-center text-sm pt-2 border-t border-white/5">
                  <span className="font-bold text-[#5EEAD4]">Total Donation Dakshina:</span>
