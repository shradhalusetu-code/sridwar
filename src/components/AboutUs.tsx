...
export default function AboutUs({ onNavigate }: AboutUsProps) {
  return (
    <section id="about-us-section" className="py-12 bg-[#021816] text-white text-left" style={{ paddingTop: `calc(var(--safe-area-inset-top, env(safe-area-inset-top, 0px)) + 80px)` }}>
