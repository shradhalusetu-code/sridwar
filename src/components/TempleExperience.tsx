...
import { Search, Compass, BookOpen, Clock, Heart, Sparkles, Check, Wifi, WifiOff, MapPin, ChevronRight, ChevronDown, Users, Bell } from "lucide-react";
          ...
          >
            ...
            <div className="lg:col-span-12 space-y-4">
              ...
              <h3 className="font-serif text-2xl sm:text-3xl font-black text-white leading-tight">
                Choose a Temple for Live Sanctified Darshan
              </h3>
              <p className="text-xs text-white/60 max-w-2xl">
                Select any of our {TEMPLES_LIST.length} revered shrines below to view its dedicated Live Darshan details, Aarti timing, and devotional significance.
              </p>
            ...
            <div className="lg:col-span-7 space-y-4 mt-2">
              ...
              <div className="aspect-video w-full rounded-2xl bg-[#021816]/95 overflow-hidden relative border border-white/10 shadow-2xl flex items-center justify-center group">
                ...
                {/* Coming soon message overlay — replaces misleading live indicators */}
                <div className="relative z-10 flex flex-col items-center text-center px-6 py-5 max-w-md">
                  <div className="w-11 h-11 rounded-full bg-amber-500/15 border border-amber-400/40 flex items-center justify-center mb-3">
                    <Bell className="w-5 h-5 text-amber-300" />
                  </div>
                  <p className="text-sm sm:text-base font-bold text-white leading-snug">
                    Live Darshan will be available soon once the sanctified live feed is updated.
                  </p>
                  <p className="text-[11px] text-white/60 mt-2 leading-relaxed">
                    Some temple feeds are livestreamed only on specific dates and times — check the Active Aarti Timing below for this shrine.
                  </p>
                </div>
            ...
            <div className="lg:col-span-5 p-2 flex flex-col justify-between text-left space-y-6 h-full mt-2">
              <div className="space-y-4">
                <div className="text-xs text-white bg-white/5 px-3.5 py-2 rounded-xl border border-white/10">
                ...
                <div className="p-4 bg-white/5 rounded-2xl border border-white/15 space-y-2.5">
                  ...
                  <div className="flex items-center justify-between text-xs text-white/85 gap-3">
                    <span className="font-bold shrink-0 flex items-center space-x-1"><Users className="w-3.5 h-3.5 text-[#5EEAD4]" /><span>Est. Devotees Watching:</span></span>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2 p-3 bg-amber-500/10 rounded-xl border border-amber-400/25">
                  <Bell className="w-4 h-4 text-amber-300 shrink-0 mt-0.5" />
                  <span className="text-[11px] text-amber-100 leading-relaxed">
                    Live Darshan will be available soon once the sanctified live feed is updated. Some feeds stream only on specific dates and times.
                  </span>
                </div>
