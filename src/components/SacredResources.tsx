...
export default function SacredResources() {
  return (
    <section id="sacred-daily-tools" className="py-10 bg-[#021816] border-t border-white/10 text-left relative z-10" style={{ paddingTop: `calc(env(safe-area-inset-top, 0px) + 80px)` }}>
