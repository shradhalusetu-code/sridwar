    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-4 bg-[#092320]/40 border border-white/5 p-4 rounded-2xl flex items-start space-x-3 text-[13px] text-white/55 font-sans leading-relaxed">
          <span className="text-base shrink-0">🙏</span>
          <p className="text-left">
            <strong>A Gentle Note:</strong> With good faith, the information shared above offers general devotee guidance and reflects our current rituals, processes, and policies as accurately as we can. Temple timings, priest availability, Vedic procedures, pricing, shipping schedules, and platform features may naturally evolve with festival calendars, temple-trust directives, or operational needs, and Sri Dwar (Shradhalu Private Limited) may gently update, amend, or discontinue any term, service detail, or policy referenced in this FAQ section. Where reasonably possible, we'll lovingly let devotees know of any material changes in advance via the registered email, WhatsApp, or the Devotee Console; continuing to use the platform after such updates are shared is taken as your acceptance of the revised terms. For the most current details on any specific booking, ritual, or seva, please do reach out to our Devotee Care desk before proceeding.
          </p>
        </div>
