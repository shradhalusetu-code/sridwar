...
const SERVICE_OPTIONS: Record<PlanCategoryId, string[]> = {
  devotee: ["Puja Bookings", "Seva & Donations", "Live Darshan", "Prasad Delivery", "Astrology Consultations", "Community Events"],
  ...
  seva: ["Annadanam Drives", "Prasad Distribution", "Disaster Relief", "Volunteer Coordination", "Donation Collection", "Community Welfare"],
};
