...
export const COMMISSION_STRUCTURE: CommissionTier[] = [
  { bookingLabel: "1st Booking", rate: 10, description: "First eligible puja, seva, contribution, product, or consultation booked by your referred devotee." },
  { bookingLabel: "2nd Booking", rate: 5, description: "Second eligible booking by the same referred devotee." },
  { bookingLabel: "3rd–8th Booking", rate: 3, description: "Every eligible booking from the 3rd through the 8th booking by the same referred devotee. Cashback eligibility ends after that devotee's 8th successful booking." },
];
...
export const DEVOTEE_REFERRAL_TIERS: DevoteeReferralTier[] = [
  {
    ...
    networkCommissionRate: "Guide devotees to their first blessings and earn 2% cashback on every eligible booking they complete",
  ...
  },
  {
    ...
    networkCommissionRate: "Walk beside more devotees on their journey and earn 5% cashback on every eligible booking they complete",
  ...
  },
  {
    ...
    networkCommissionRate: "Answer the call of your growing circle and earn 8% cashback on every eligible booking your devotees complete",
  ...
  },
  {
    ...
    networkCommissionRate: "Lead a thriving circle of devotees and earn 11% cashback on every eligible booking they complete",
  ...
  },
  {
    ...
    networkCommissionRate: "Set the wheel of dharma in motion for your whole community and earn 14% cashback on every eligible booking your devotees complete",
...
export const PUJARI_TIERS: ProviderCategoryTier[] = [
  {
    ...
    commissionEligibility: "Standard referral cashback structure (10% / 5% / 3%)",
  ...
  },
  {
    ...
    feeModel: "Set your own dakshina + 1% cashback boost across all tiers (11% / 6% / 4%)",
    customerReach: "Targets approx. ₹25,000 worth of opportunities or 80 rituals/month",
    commissionEligibility: "+1% cashback boost on all tiers (11% / 6% / 4%)",
  ...
  },
  {
    ...
    feeModel: "Set your own dakshina + 2% cashback boost across all tiers (12% / 7% / 5%)",
    customerReach: "Benefits exceeding ₹60,000 worth of opportunities and 200+ rituals/month",
    commissionEligibility: "+2% cashback boost on all tiers (12% / 7% / 5%)",
  ...
  },
  {
    ...
    feeModel: "Set your own dakshina + 3% cashback boost across all tiers (13% / 8% / 6%)",
    customerReach: "Unlimited genuine customer access — no monthly enquiry cap",
    commissionEligibility: "+3% cashback boost on all tiers (13% / 8% / 6%)",
...
export const PUJA_MANDAL_TIERS: ProviderCategoryTier[] = [
  ...
  },
  {
    ...
    feeModel: "Collect contributions + 1% cashback boost across all tiers (11% / 6% / 4%)",
  ...
  },
  {
    ...
    feeModel: "Collect contributions + 2% cashback boost across all tiers (12% / 7% / 5%)",
  ...
  },
  {
    ...
    feeModel: "Collect contributions + 3% cashback boost across all tiers (13% / 8% / 6%)",
...
export const YOGA_GURU_TIERS: ProviderCategoryTier[] = [
  ...
  },
  {
    ...
    feeModel: "Set your own fees + 1% cashback boost across all tiers (11% / 6% / 4%)",
  ...
  },
  {
    ...
    feeModel: "Set your own fees + 2% cashback boost across all tiers (12% / 7% / 5%)",
  ...
  },
  {
    ...
    feeModel: "Set your own fees + 3% cashback boost across all tiers (13% / 8% / 6%)",
...
export const SEVA_PROVIDER_TIERS: ProviderCategoryTier[] = [
  ...
  },
  {
    ...
    feeModel: "No platform markup + 1% referral cashback boost (11% / 6% / 4%)",
  ...
  },
  {
    ...
    feeModel: "No platform markup + 2% referral cashback boost (12% / 7% / 5%)",
  ...
  },
  {
    ...
    feeModel: "No platform markup + 3% referral cashback boost (13% / 8% / 6%)",
